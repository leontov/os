...
6. Сформирована инфраструктура технической готовности: `scripts/build_iso.sh`, `scripts/build_wasm.sh`, цель `make check` и релизные заметки фиксируют контроль ISO/WASM и CI.
