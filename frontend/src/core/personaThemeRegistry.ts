    ...
    tokens: {
      light: {
        colors: {
          ...
          border: "214 221 255",
          text: "26 35 85",
          "text-muted": "92 103 152",
          primary: "79 70 229",
          accent: "14 165 233",
          "background-card": "255 255 255",
          "background-input": "236 241 255",
          "background-panel": "244 247 255",
          "border-strong": "196 205 244",
          "text-primary": "26 35 85",
          "text-secondary": "92 103 152",
        },
        typography: {
      ...
      dark: {
        colors: {
          ...
          border: "58 69 121",
          text: "226 232 240",
          "text-muted": "177 186 222",
          primary: "129 140 248",
          accent: "125 211 252",
          "background-card": "26 31 68",
          "background-input": "21 25 58",
          "background-panel": "22 27 63",
          "border-strong": "84 96 150",
          "text-primary": "226 232 240",
          "text-secondary": "176 186 216",
        },
        typography: {
          fontFamily: '"Inter", "Segoe UI", sans-serif',
          headingFamily: '"Clash Display", "Inter", sans-serif',
